...
- Vault Agent rendered secret files are `0440` and live under consumer-specific subdirectories (`runtime/secrets/bot/`, `runtime/secrets/poller/`, `runtime/secrets/ts-sidecar/`, `runtime/secrets/vault-agent/`).
