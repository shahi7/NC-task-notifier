...
bootstrap_runtime() {
  ...
  # fix 2026-07-27: signal-cli writes state here as APP_UID.
  chmod 2770 "$REPO_ROOT/data/signal" 2>/dev/null || true
  chmod 660 "$REPO_ROOT/data/signal/.gitkeep" 2>/dev/null || true
}
